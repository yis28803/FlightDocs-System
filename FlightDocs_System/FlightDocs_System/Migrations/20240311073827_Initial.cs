    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aircraft", x => x.ID_Aircraft);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Pilot = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pilots", x => x.ID_Pilot);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flights_Aircraft_ID_Aircraft",
                        column: x => x.ID_Aircraft,
                        principalTable: "Aircraft",
                        principalColumn: "ID_Aircraft",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Pilots_ID_Pilot",
                        column: x => x.ID_Pilot,
                        principalTable: "Pilots",
                        principalColumn: "ID_Pilot",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_ID_Aircraft",
                table: "Flights",
                column: "ID_Aircraft");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_ID_Pilot",
                table: "Flights",
                column: "ID_Pilot");
        }
